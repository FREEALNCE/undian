...
@section('content')
    <div class="row">
      <div class="col-12">
        ...
        <form action="{{ route('third-page.update', 1) }}" method="POST" enctype="multipart/form-data">
          @method('PUT')
          @csrf
              ...
              <div class="row">
                <div class="col-12">
                  <div class="float-right mTop">
                    <a class="btn btn-outline-primary _btn-primary px-4" href="{{ route('third-page.index') }}">Back</a>
