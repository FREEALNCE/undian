...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl navbar-custom" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            ...
            {{ Breadcrumbs::render('second_page') }}
        </nav>
...
@section('content')
    <div class="row">
      <div class="col-12">
        ...
        <form action="{{ route('second-page.update', 1) }}" method="POST" enctype="multipart/form-data">
          @method('PUT')
          @csrf
              ...
              <div class="row">
                <div class="col-12">
                  <div class="float-right mTop">
                    <a class="btn btn-outline-primary _btn-primary px-4" href="{{ route('second-page.index') }}">Back</a>
