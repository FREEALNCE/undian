...
<div class="row">
    <div class="col-md-12 dn-table">
        <form action="{{url('dashboard/days/update')}}" method="POST">
            @php
                $kode = str_split($row->kode_siang);
            @endphp
            @csrf
                        ...
                        <div class="col-12" style="display: flex; justify-content: center; align-items: center;">
                            ...
                            <div class="form-group{{ $errors->has('tanggal') ? ' has-error' : '' }} _form-group" style="display: flex; justify-content: center; align-items: center; text-align: center;">
                                ...
                                <div class="form-group">
                                        <input type="date" value="{{ $row->tanggal}}" class="form-control" name="tanggal" required>
                                </div>
                            </div>
                        </div>
                    </div>
