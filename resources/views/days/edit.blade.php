...
<div class="row">
    <div class="col-md-12 dn-table">
        <form action="{{ route('days.update', ['day' => $day]) }}" method="POST">
            @method('PUT')
            @csrf
            <div class="card">
                    ...
                    <div class="row d-flex align-items-stretch" style="justify-content: center;">
                        <div class="col-md-2">
                            ...
                            <div class="form-group _form-group">
                                ...
                                <input id="input_banner_title" value="{{ old('num_one', $day->num_one) }}" name="num_one" type="number" min="0" class="form-control num-box @error('num_one') is-invalid @enderror" placeholder="Ex: 0" />
                                @error('num_one')
                        ...
                        <div class="col-md-2 col-sm-12">
                            ...
                            <div class="form-group _form-group">
                                ...
                                <input id="input_banner_title" value="{{ old('num_two', $day->num_two) }}" name="num_two" type="number" min="0" class="form-control num-box @error('num_two') is-invalid @enderror" placeholder="Ex: 0" />
                                @error('num_two')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-2 col-sm-12">
                            ...
                            <div class="form-group _form-group">
                                ...
                                <input id="input_banner_title" value="{{ old('num_three', $day->num_three) }}" name="num_three" type="number" min="0" class="form-control num-box @error('num_three') is-invalid @enderror" placeholder="Ex: 0" />
                                @error('num_three')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-2 col-sm-12">
                            ...
                            <div class="form-group _form-group">
                                ...
                                <input id="input_banner_title" value="{{ old('num_four', $day->num_four) }}" name="num_four" type="number" min="0" class="form-control num-box @error('num_four') is-invalid @enderror" placeholder="Ex: 0" />
                                @error('num_four')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-2 col-sm-12">
                            ...
                            <div class="form-group _form-group">
                                ...
                                <input id="input_banner_title" value="{{ old('num_five', $day->num_five) }}" name="num_five" type="number" min="0" class="form-control num-box @error('num_five') is-invalid @enderror" placeholder="Ex: 0" />
                                @error('num_five')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-12" style="display: flex; justify-content: center; align-items: center;">
                            ...
                            <div class="form-group{{ $errors->has('is_active') ? ' has-error' : '' }} _form-group" style="display: flex; justify-content: center; align-items: center; text-align: center;">
                                ...
                                <div class="form-group">
                                    <label class="switch">
                                        <input type="checkbox" name="is_active" {{ old('is_active', $day->is_active) == 1 ? 'checked' : null }}>
