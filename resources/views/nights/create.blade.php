...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl navbar-custom" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            ...
            {{ Breadcrumbs::render('tambah_night') }}
        </nav>
                    ...
                    <div class="row d-flex align-items-stretch" style="justify-content: center;">
                        <div class="col-md-2">
                            ...
                            <div class="form-group _form-group">
                                ...
                                <input id="input_banner_title" value="{{ old('num_one') }}" name="num_one" type="number" min="0" class="form-control num-box @error('num_one') is-invalid @enderror" placeholder="Ex: 0" />
                                @error('num_one')
                        ...
                        <div class="col-md-2 col-sm-12">
                            ...
                            <div class="form-group _form-group">
                                ...
                                <input id="input_banner_title" value="{{ old('num_two') }}" name="num_two" type="number" min="0" class="form-control num-box @error('num_two') is-invalid @enderror" placeholder="Ex: 0" />
                                @error('num_two')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-2 col-sm-12">
                            ...
                            <div class="form-group _form-group">
                                ...
                                <input id="input_banner_title" value="{{ old('num_three') }}" name="num_three" type="number" min="0" class="form-control num-box @error('num_three') is-invalid @enderror" placeholder="Ex: 0" />
                                @error('num_three')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-2 col-sm-12">
                            ...
                            <div class="form-group _form-group">
                                ...
                                <input id="input_banner_title" value="{{ old('num_four') }}" name="num_four" type="number" min="0" class="form-control num-box @error('num_four') is-invalid @enderror" placeholder="Ex: 0" />
                                @error('num_four')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-2 col-sm-12">
                            ...
                            <div class="form-group _form-group">
                                ...
                                <input id="input_banner_title" value="{{ old('num_five') }}" name="num_five" type="number" min="0" class="form-control num-box @error('num_five') is-invalid @enderror" placeholder="Ex: 0" />
                                @error('num_five')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
