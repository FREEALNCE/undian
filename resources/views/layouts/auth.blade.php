...
<body class="bg-gray-200">
    <div class="container position-sticky z-index-sticky top-0">
        <div class="row">
            <div class="col-12">
                ...
                <img src="{{ asset('images/icon-capt.png') }}" alt="">
                </a>
    ...
    <script src="{{ asset('scripts/smooth-scrollbar.min.js') }}"></script>
    <script>
    ...
    <script src="{{ asset('scripts/material-dashboard.min.js?v=3.0.2') }}"></script>
</body>
