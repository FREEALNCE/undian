...
<div class="row">
    <div class="col-md-12 dn-table">
        <form action="{{url('dashboard/update-night-time')}}" method="POST">
            @csrf
                ...
                <div class="card-body _card-body">
                    <div class="row d-flex align-items-stretch" style="justify-content: center;">
                        <div class="col-12">
                            ...
                            <input type="time" class="form-control form-control-sm" name="jam_malam" value="{{$row->jam_malam}}" id="time" required>
                        </div>
                    </div>
